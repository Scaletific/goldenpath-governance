...
relates_to:
  ...
  - GOV-0043-config-driven-metadata
supersedes: []
superseded_by: []
tags: []
inheritance: {}
...
All field values will be validated against the canonical [`enums.yaml`](../../schemas/metadata/enums.yaml), ensuring cross-repository consistency.
