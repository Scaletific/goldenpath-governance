...
| `scripts/rag/` | Governance RAG pipeline — hybrid retrieval (vector + BM25 + Neo4j graph), LLM synthesis, MCP server |
| `rag-web-ui/` | RAG Web UI — FastAPI backend + React frontend for querying indexed governance docs |
